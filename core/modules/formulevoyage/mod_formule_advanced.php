...
/**
 * \file       htdocs/core/modules/formulevoyage/mod_formule_advanced.php
 * \ingroup    formulevoyage
 * \brief      File containing class for advanced numbering model of Formule
 */

dol_include_once('/formulevoyage/core/modules/formulevoyage/modules_formule.php');


/**
 *	Class to manage the Advanced numbering rule for Formule
 */
class mod_formule_advanced extends ModeleNumRefFormule
{
	/**
	...
	public function info()
	{
		...
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("Formule"), $langs->transnoentities("Formule"));
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'formulevoyage_formule', 'ref', '', null, $date);
