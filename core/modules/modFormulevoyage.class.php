...
/**
 * 	\defgroup   formulevoyage     Module Formulevoyage
 *  \brief      Formulevoyage module descriptor.
 *
 *  \file       htdocs/formulevoyage/core/modules/modFormulevoyage.class.php
 *  \ingroup    formulevoyage
 *  \brief      Description and activation file for module Formulevoyage
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module Formulevoyage
 */
class modFormulevoyage extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 5000001; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module

		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'formulevoyage';
		...
		// Module label (no space allowed), used if translation string 'ModuleFormulevoyageName' not found (Formulevoyage is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// Module description, used if translation string 'ModuleFormulevoyageDesc' not found (Formulevoyage is name of module).
		$this->description = "FormulevoyageDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "FormulevoyageDescription";

		// Author
		$this->editor_name = 'Ets Lescaut';
		$this->editor_url = '';
		...
		// Key used in llx_const table to save module status enabled/disabled (where FORMULEVOYAGE is value of property name of module in uppercase)
		...
		// Example: this->dirs = array("/formulevoyage/temp","/formulevoyage/subdir");
		$this->dirs = array("/formulevoyage/temp");

		// Config pages. Put here list of php page, stored into formulevoyage/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@formulevoyage");
		...
		$this->langfiles = array("formulevoyage@formulevoyage");
		...
		//$this->automatic_activation = array('FR'=>'FormulevoyageWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('FORMULEVOYAGE_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('FORMULEVOYAGE_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isset($conf->formulevoyage) || !isset($conf->formulevoyage->enabled)) {
			$conf->formulevoyage = new stdClass();
			$conf->formulevoyage->enabled = 0;
		}
        ...
        $this->tabs[] = array('data'=>'formulevoyage:-agenda');
		...
		$this->dictionaries=array(
			...
			// Condition to show each dictionary
			'tabcond'=>array(isModEnabled('formulevoyage'), isModEnabled('formulevoyage'), isModEnabled('formulevoyage')),
		...
		*/
		...
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("formulevoyage")', 'priority'=>50)
		// );
...
//
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'formulevoyage');
		$result = $this->_load_tables('/formulevoyage/sql/');
		if ($result < 0) {
		...
		//$result5=$extrafields->addExtraField('formulevoyage_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'formulevoyage@formulevoyage', 'isModEnabled("formulevoyage")');
