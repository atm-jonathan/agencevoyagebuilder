...
print dol_get_fiche_head($head, 'about', $langs->trans($page_name), 0, 'formulevoyage@formulevoyage');

dol_include_once('/formulevoyage/core/modules/modFormulevoyage.class.php');
$tmpmodule = new modFormulevoyage($db);
