...
/**
 *	\file       formulevoyage/formulevoyageindex.php
 *	\ingroup    formulevoyage
 *	\brief      Home page of formulevoyage top menu
 */
...
$langs->loadLangs(array("formulevoyage@formulevoyage"));
...
llxHeader("", $langs->trans("FormulevoyageArea"));

print load_fiche_titre($langs->trans("FormulevoyageArea"), '', 'formulevoyage.png@formulevoyage');
